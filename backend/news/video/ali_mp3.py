...
def fileTrans(akId, akSecret, appKey, fileLink) :
    ...
    if statusText == STATUS_SUCCESS :
        print ("录音文件识别成功！")
        return getResponse[KEY_RESULT]
    else :
        print ("录音文件识别失败！")
        return ''

fileLink = "http://cloudbed.cn/file/mp3/ford1_1600.mp3"
def transferMp3ToText(fileLink):
    accessKeyId = "LTAI4GD3uZc5eGXHtustt68w"
    accessKeySecret = "EicjId1cYJFd3HXAyhXwumWFpfXzBa"
    appKey = "fDEJf8xQb88Q83vw"
    # 执行录音文件识别
    return fileTrans(accessKeyId, accessKeySecret, appKey, fileLink)